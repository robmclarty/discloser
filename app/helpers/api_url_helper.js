...
export const apiMessagesUrl = userId =>
  `${API_ROOT_URL}/users/${userId}/messages`

export const apiMessageUrl = (userId, id) =>
  `${API_ROOT_URL}/users/${userId}/messages/${id}`

export const apiKeysUrl = userId => `${API_ROOT_URL}/users/${userId}/keys`

export const apiKeyUrl = (userId, id) =>
  `${API_ROOT_URL}/users/${userId}/keys/${id}`
